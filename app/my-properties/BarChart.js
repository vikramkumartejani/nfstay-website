            ...
            <div className="flex justify-between flex-wrap gap-5">
                ...
                <div className="flex gap-[10px]">
                    <button
                        ...
                        className={`text-[14px] font-[500] leading-[19.6px] w-[34px] h-[34px] rounded-full ${activeButton === "D"
                    ...
                    <button
                        ...
                        className={`text-[14px] font-[500] leading-[19.6px] w-[34px] h-[34px] rounded-full ${activeButton === "W"
                                ? "text-white bg-[#954AFC]"
                                : "text-primary-color opacity-[0.5]"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`text-[14px] font-[500] leading-[19.6px] w-[34px] h-[34px] rounded-full ${activeButton === "M"
                                ? "text-white bg-[#954AFC]"
                                : "text-primary-color opacity-[0.5]"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`text-[14px] font-[500] leading-[19.6px] w-[34px] h-[34px] rounded-full ${activeButton === "Y"
                                ? "text-white bg-[#954AFC]"
                                : "text-primary-color opacity-[0.5]"
                            }`}
                    >
