            ...
            <div className="bg-white rounded-[20px] shadow-lg md:px-[25px] md:py-[25px] py-[20px] px-[15px] max-w-[580px] max-h-screen w-full overflow-y-auto">
                ...
                <div className="sm:pt-[25px] pt-[15px]">
                    ...
                    <div className="flex sm:flex-row flex-col sm:gap-[18px] gap-[6px] md:items-center justify-between bg-[#0C0839] bg-opacity-[0.04] rounded-[14px] p-[15px]">
                        <p className="text-[#0C0839] text-[16px] font-medium leading-[24px] capitalize">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nunc ipsum, accumsan vitae quam nec, vestibulum eleifend massa. Morbi varius accumsan laoreet. Aenean imperdiet ut dui ac imperdiet. Donec eu metus at ipsum fermentum ornare.</p>
                    </div>
                    ...
                    <div className="sm:pt-[25px] pt-[15px]">
                        ...
                        <div className="flex flex-wrap sm:gap-[20px] gap-[6px] items-center justify-between">
                            <button
                                ...
                                className={`flex items-center sm:gap-[12px]x     gap-[6px] text-primary-color flex-1 p-3 rounded-[10px] justify-between ${selected === "card"
                            ...
                            >
                                <div className="flex items-center gap-[6px]">
                                    <div
                                        className={`p-[8px] rounded-[10px] ${selected === "Yes" ? "bg-white" : "bg-[#0C08390F]"
                                            }`}
                                    >
                                ...
                                <span
                                    className={`w-[16px] h-[16px] border-[1.5px] rounded-full flex items-center justify-center ${selected === "card"
                                        ? "border-[#954AFC]"
                                        : "border-[#0000001F]"
                                        }`}
                                >
                            ...
                            <button
                                ...
                                className={`flex items-center sm:gap-[12px] gap-[6px] text-primary-color flex-1 p-3 rounded-[10px] justify-between ${selected === "crypto"
                                    ? "bg-[#954AFC0D] border-[1.5px] border-[#954AFC]"
                                    : "bg-white border-[1.5px] border-[#0000001A]"
                                    }`}
                            >
                                <div className="flex items-center gap-[6px]">
                                    <div
                                        className={`p-[8px] rounded-[10px] ${selected === "No" ? "bg-white" : "bg-[#0C08390F]"
                                            }`}
                                    >
                                ...
                                <span
                                    className={`w-[16px] h-[16px] border-[1.5px] rounded-full flex items-center justify-center ${selected === "crypto"
                                        ? "border-[#954AFC]"
                                        : "border-[#0000001F]"
                                        }`}
                                >
