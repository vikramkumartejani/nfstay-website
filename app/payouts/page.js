        ...
        <DashboardLayout>
            <div className='px-4 md:px-6'>
                <div className="bg-white text-primary-color">
                    <h2 className="md:text-[32px] text-[25px] md:leading-[40.32px] tracking-[-2%] font-bold text-primary-color pt-[120px] lg:pt-[16px] md:pb-[30px] pb-[16px]">
                        Payouts
                    </h2>
                                    ...
                                    >
                                        <td className="font-semibold text-[14px] md:text-[16px] leading-[23px] text-[#0C0839] py-[20px] flex items-center">
                                            ...
                                            <div className='flex items-start flex-col'>
                                                <h1 className="text-[16px] leading-[23px] font-semibold font-jakarta text-[#0C0839] pr-4 md:pr-6">
                                                    {payout.propertyName}
                                                </h1>
                                            </div>
                                        </td>
                                        ...
                                        <td className="font-semibold text-[14px] md:text-[16px] leading-[23px] text-[#0C0839] px-[12px] md:px-[23px] py-[20px] text-center">
                                            {payout.nftssowned}
                                        </td>
                                        <td className="font-semibold text-[14px] md:text-[16px] leading-[23px] text-[#0C0839] px-[12px] md:px-[23px] py-[20px] text-center">
                                            {payout.payout}
                                        ...
                                        <td className="font-semibold text-[12px] leading-[23px] text-white px-[12px] md:px-[23px] py-[20px] text-center">
                                            <button className='bg-[#954AFC] rounded-[6px] px-[15px] py-[5px]'>Claim & Reinvest</button>
                                        </td>
                                        <td className="font-semibold text-[12px] leading-[23px] text-white px-[12px] md:px-[23px] py-[20px] text-center">
                                            <div>
