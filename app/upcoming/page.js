  ...
  return (
    <DashboardLayout>
        <div className='px-3 md:px-[25px] pt-[120px] lg:pt-[32px]'>
            <h1 className='text-[#0C0839] text-[28px] sm:text-[32px] leading-[40.32px] tracking-[-0.02em] font-bold mb-1.5'>Upcoming Properties</h1>
            <p className='text-[#0C0839] text-[16px] sm:text-[18px] leading-[27px] font-medium opacity-50'>Mint exclusive Real Estate NFTs before they hit the secondary market</p>
